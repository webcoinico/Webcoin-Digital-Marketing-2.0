...
/**
  * @dev Webcoin token smart contract
  * @param _cap The cap of tokens to be ever minted.
  * @param _wallets The wallets for tokens distribution.
  * @note Webcoin ERC20 implementation with standard CappedToken OpenZeppelin libraries
  */
